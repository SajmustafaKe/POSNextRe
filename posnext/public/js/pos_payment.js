...
posnext.PointOfSale.Payment = class {
    ...
    prepare_dom() {
        ...
        // Add CSS for split payment toggle
    ...
    bind_events() {
        ...
        // Additional event handlers from the second snippet
                ...
                return (`
                    <div class="payment-mode-wrapper">
                        <div class="mode-of-payment" data-mode="${mode}" data-payment-type="${payment_type}">
                            ...
                            <button class="add-to-split-btn btn btn-sm btn-primary" style="margin-top: 5px;">
                                ${__('Add to Split')}
                            </button>
                        </div>
                    </div>
    ...
    add_split_payment(mode, amount) {
        ...
        this.split_payments.push({
            ...
            reference_number: '', // Can be filled by user for tracking
            notes: '' // Additional notes for this specific payment
        });
    ...
    remove_split_payment(index) {
        ...
        // Renumber same payment method references
    ...
    store_split_payment_summary(doc) {
        ...
        // Store in a custom field or remarks - adjust based on your setup
        ...
        // You can store this in a custom field like 'split_payment_details'
        // frappe.model.set_value(doc.doctype, doc.name, 'split_payment_details', summary_text);
    ...
    // Missing functions from the second snippet
    ...
    focus_on_default_mop() {
        ...
        payments.forEach(p => {
            ...
            if (p.default) {
                setTimeout(() => {
                    this.$payment_modes.find(`.${mode}.mode-of-payment`).click();
                }, 500);
            }
        });
    }
